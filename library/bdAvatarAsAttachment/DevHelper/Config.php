<?php
class bdAvatarAsAttachment_DevHelper_Config extends DevHelper_Config_Base
{
	protected $_dataClasses = array();
	protected $_dataPatches = array();
	protected $_exportPath = '/Users/sondh/XenForo/bdAttachmentStore/MORE/bdAvatarAsAttachment';
